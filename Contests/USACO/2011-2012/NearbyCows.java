...
public class NearbyCows {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader reader = new BufferedReader(new FileReader("nearcows.in"));
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter("nearcows.out")));
