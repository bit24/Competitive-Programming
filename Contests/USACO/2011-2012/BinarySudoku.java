...
public class BinarySudoku {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader reader = new BufferedReader(new FileReader("bsudoku.in"));
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter("bsudoku.out")));
